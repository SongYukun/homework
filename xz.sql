...
/**笔记本电脑型号家族**/
CREATE TABLE movie_laptop_family(
  fid INT PRIMARY KEY AUTO_INCREMENT,
  fname VARCHAR(32)
);

/**笔记本电脑**/
CREATE TABLE movie_laptop(
...
/**收货地址信息**/
CREATE TABLE movie_receiver_address(
...
/**购物车条目**/
CREATE TABLE movie_shoppingcart_item(
...
/**用户订单**/
CREATE TABLE movie_order_detail(
...
/****首页轮播广告商品****/
CREATE TABLE movie_index_carousel(
